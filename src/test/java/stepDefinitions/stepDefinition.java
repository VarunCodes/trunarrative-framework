...
public class stepDefinition extends testBase {
	...
	public void the_following_members_have_their_respective_roles(DataTable teamTable) throws Throwable {
		...
		for (int i = 0; i < list.size(); i++) {
			WebElement role1 = driver.findElement(By.xpath("//*[text() = '" + list.get(i).get("name") + "']/following-sibling::p[1]"));
			//System.out.println(role1.getText());
			Assert.assertEquals(role1.getText(), list.get(i).get("role"));
		}
	...
	public void it_appears_as_the_first_search_result() throws Throwable {
		// String resultMatch =
		// driver.findElement(By.xpath(xpathFirstResult)).getText();
